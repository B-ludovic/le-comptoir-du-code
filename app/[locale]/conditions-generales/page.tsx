      ...
      <main className={styles.main}>
        <div className="container">
          ...
          <p className={styles.text} style={{ opacity: 0.6, fontSize: '0.85rem', marginBottom: '2rem' }}>
            {isFr ? 'Dernière mise à jour : 17 août 2026 (v5)' : 'Last updated: August 17, 2026 (v5)'}
          </p>
