...
const articles = {
  fr: [
    ...
    },
    {
      ...
      content:
        "Lorsque le Client est un consommateur au sens du code de la consommation, il dispose d'un délai de quatorze (14) jours à compter de la conclusion du contrat pour exercer son droit de rétractation, sans avoir à motiver sa décision.\n\nLe Client peut toutefois demander expressément l'exécution de la prestation avant l'expiration de ce délai, en cochant et paraphant la mention prévue à cet effet sur le devis. Conformément à l'article L221-25 du code de la consommation, le Client ayant formulé cette demande et dont la prestation a été pleinement exécutée avant la fin du délai perd son droit de rétractation. En cas d'exécution partielle, le Client demeure redevable du montant correspondant à la prestation déjà fournie.",
    },
    {
  ...
  en: [
    ...
    },
    {
      ...
      content:
        "Where the Client is a consumer within the meaning of the French Consumer Code, they have a period of fourteen (14) days from the conclusion of the contract to exercise their right of withdrawal, without needing to give reasons.\n\nThe Client may however expressly request that the service be performed before the end of that period, by ticking and initialling the corresponding statement on the quote. In accordance with Article L221-25 of the French Consumer Code, a Client who has made such a request and whose service has been fully performed before the end of the period loses the right of withdrawal. In the event of partial performance, the Client remains liable for the amount corresponding to the service already provided.",
    },
    {
