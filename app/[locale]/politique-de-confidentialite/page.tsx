    ...
    <>
      ...
      <main className={styles.main}>
        <div className="container">
          ...
          <div className={styles.block}>
            <h2 className={styles.heading}>{isFr ? 'Transit des données' : 'Data transit'}</h2>
            <p className={styles.text}>
              {isFr ? (
                <>
                  <a href="https://improvmx.com/" target="_blank" rel="noopener noreferrer">
                    ImprovMX
                  </a>{' '}
                  — les emails envoyés via le formulaire transitent de manière sécurisée par leur
                  service transactionnel, pour atterrir directement dans ma boîte de réception
                  professionnelle.
                </>
              ) : (
                <>
                  Emails sent via the form are securely transmitted through{' '}
                  <a href="https://improvmx.com/" target="_blank" rel="noopener noreferrer">
                    ImprovMX
                  </a>
                  {"'"}s transactional service, landing directly in my professional inbox.
                </>
              )}
            </p>
          </div>
          ...
          <div className={styles.block}>
            <h2 className={styles.heading}>{isFr ? 'Vos droits' : 'Your rights'}</h2>
            <p className={styles.text}>
              {isFr
              ...
              <a href="mailto:contact@lechoppeducode.com">contact@lechoppeducode.com</a>
            </p>
          </div>
        </div>
      </main>
